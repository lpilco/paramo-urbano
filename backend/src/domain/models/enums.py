...
class SubgoalType(str, Enum):
    ...
    ROAD_HALF_MARATHON = "ROAD_HALF_MARATHON"
    MARATHON = "MARATHON"
    ROAD_MARATHON = "ROAD_MARATHON"
    ULTRA_ROAD = "ULTRA_ROAD"
    TRAIL_SHORT = "TRAIL_SHORT"
    TRAIL_HALF_MARATHON = "TRAIL_HALF_MARATHON"
    TRAIL_MARATHON = "TRAIL_MARATHON"
    ULTRA_TRAIL = "ULTRA_TRAIL"
    HIGH_MOUNTAIN_TREK = "HIGH_MOUNTAIN_TREK"
    ALPINISMO_TREKKING = "ALPINISMO_TREKKING"
