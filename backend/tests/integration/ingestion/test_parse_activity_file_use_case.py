...
class TestParseActivityFileUseCaseIntegration:
    ...
    @pytest.fixture
    def use_case(self, dedup_registry: InMemoryDeduplicationRegistry) -> ParseActivityFileUseCase:
        return ParseActivityFileUseCase(deduplication_registry=dedup_registry)

    def test_ingest_valid_fit_file_orchestration(self, use_case: ParseActivityFileUseCase) -> None:
    ...
    def test_deduplication_cryptographic_sha256(self, use_case: ParseActivityFileUseCase) -> None:
    ...
    def test_ingest_gpx_trail_file_orchestration(self, use_case: ParseActivityFileUseCase) -> None:
    ...
    def test_ingest_garmin_csv_export_orchestration(self, use_case: ParseActivityFileUseCase) -> None:
    ...
    def test_sport_category_override(self, use_case: ParseActivityFileUseCase) -> None:
    ...
    def test_corrupted_fit_propagates_invalid_header_exception(self, use_case: ParseActivityFileUseCase) -> None:
    ...
    def test_xxe_attack_propagates_security_exception(self, use_case: ParseActivityFileUseCase) -> None:
    ...
    def test_empty_payload_raises_corrupted_file_exception(self, use_case: ParseActivityFileUseCase) -> None:
