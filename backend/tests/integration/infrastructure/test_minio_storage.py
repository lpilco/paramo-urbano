...
class TestMinioStorageAdapterIntegration:
    ...
    @pytest.mark.asyncio
    async def test_upload_and_download_raw_bytes_integrity(self, storage: MinioStorageAdapter) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_nonexistent_file_raises_filenotfound(self, storage: MinioStorageAdapter) -> None:
    ...
    @pytest.mark.asyncio
    async def test_reject_non_bytes_payload(self, storage: MinioStorageAdapter) -> None:
    ...
    @pytest.mark.asyncio
    async def test_ensure_bucket_exists_idempotency(self, storage: MinioStorageAdapter) -> None:
